...
namespace Game.Data
{
    public static class Colors
    {
        ...
        // main menu buttons
        public static readonly Color MainMenu_Button_CreateWorld = new Color(0, 0, 0);
        public static readonly Color MainMenu_Text_CreateWorld = new Color(255, 255, 255);
        public static readonly Color MainMenu_Button_CreateWorld_Highlight = new Color(255, 255, 255);
        public static readonly Color MainMenu_Text_CreateWorld_Highlight = new Color(0, 92, 128);
