    ...
    public partial class Block
    {
        ...
        static Block()
        {
            s_blockArray = ImmutableArray.Create(new Block[] {
                ...
                new Block("Dirt Block", new Color(96, 48, 0), 3, texture: Textures.Shaded),
                new GrassBlock("Grass Block", new Color(32, 160, 16), 3, texture: Textures.Shaded),
                new Block("Stone Block", new Color(192, 192, 192), 7, texture: Textures.Shaded),
